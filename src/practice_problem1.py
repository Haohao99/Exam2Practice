...
class Box(object):
    ...
    def append_string(self, additional_contents):
        ...
        #    and continue working on the problem.
        # --------------------------------------------------------------
        k = len(self.contents) + len(additional_contents)
        b = self.volume - len(self.contents)
        if k > self.volume:
            self.contents = self.contents+additional_contents[:b]
            s = additional_contents[b:]
            return s
        else:
